      ...
      <div class="row">
        ...
        if (!isset($_SESSION['id'])){
          ...
          if (!$data){
            ...
            <!-- Side Widget -->
            <div class="card my-4">
              <h5 class="card-header">Téléchargez vos données</h5>
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="input-group">
                    <form action="account.php?pdelete=true" method="post">
                      ...
                      <label for="confirmersup">Je confirme vouloir supprimer mon compte à vie.</label>
                      <input type="checkbox" id="supcontenu" name="supcontenu" class="form-control" required>
                      <label for="supcontenu">Supprimer également mon contenu produit (questions, réponses...)</label>
